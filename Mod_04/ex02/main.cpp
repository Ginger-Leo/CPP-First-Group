...
int main()
{
	std::cout << "main function is exactly the same aas ex01, to see compilation error, uncomment appropriate parts.\n\n";
    ...
    // std::cout << "\nTest: Create Animal\n";
    // // const Animal* meta = new Animal();  				// uncomment to see compiling error 
    // std::cout << std::endl;
    ...
    // // meta->makeSound();								// uncomment to see compiling error 
    // std::cout << std::endl;

    // // delete meta;										// uncomment to see compiling error 
    // delete j;
    // delete i;
